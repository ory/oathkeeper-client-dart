...
# Contribute to Ory Ory Oathkeeper Dart Client<!-- omit in toc -->
...
[open a well-written issue or discussion](https://github.com/ory/oathkeeper-client-dart/issues):
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/oathkeeper-client-dart/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory Ory Oathkeeper Dart Client, please follow these
guidelines:
...
git clone git@github.com:ory/oathkeeper-client-dart.git
